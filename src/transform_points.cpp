...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_imu = nh.subscribe<sensor_msgs::Imu>("/vectornav/IMU", 1000, angles);
    ros::Subscriber sub_pc2 = nh.subscribe<sensor_msgs::PointCloud2>("/quanergy/points", 100, transform);
